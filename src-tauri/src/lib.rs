...
use crate::commands::index::{backfill_chunk_embeddings, backfill_embeddings, cancel_scan, check_index_health, check_index_integrity, get_index_errors, get_index_status, get_quality_summary, heal_index_integrity, quality_audit, re_extract_file, re_extract_low_quality, rebuild_index, reextract_missing_content, reindex_file, reindex_files, restore_files, trigger_scan, verify_index_content};
