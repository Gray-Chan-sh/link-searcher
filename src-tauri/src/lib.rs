...
use crate::commands::ai::{ai_capabilities, ask_documents, conversation_ask, create_chat_session, delete_chat_session, export_chat_session, list_chat_sessions, load_chat_session, save_chat_session, smart_search, summarize_file, test_ai_gateway};
...
use crate::commands::index::{backfill_embeddings, cancel_scan, check_index_health, check_index_integrity, get_index_errors, get_index_status, rebuild_index, reindex_file, trigger_scan};
