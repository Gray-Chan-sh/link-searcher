...
1. 点击左侧导航栏的「AI 聊天」
2. 首次进入时自动创建一个新会话，输入框提示文字为「输入问题…」
...
- **导出**：聊天面板顶部提供「导出 JSON」与「导出 Markdown」两个按钮，可选择要导出的轮次后导出
...
| 4 | 总长度 | 所有材料拼起来后截断到 140k 字符（与全量召回无关） | 始终存在 | 缩小检索范围，聚焦关键文档 |
